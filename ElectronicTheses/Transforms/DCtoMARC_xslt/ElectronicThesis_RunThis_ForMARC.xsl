                ...
                <marc:record>
                    ...
                    <marc:datafield tag="502" ind1="" ind2="">
                        ...
                        <xsl:otherwise>
                            <marc:datafield tag="502" ind1="" ind2="">
                                <marc:subfield code="a">
                                    <xsl:value-of select="replace(.//dcadesc:subject[1],'[\..]$','')"/> -- Tufts University, <xsl:value-of select=".//dc:date.created"/>.</marc:subfield>
                            </marc:datafield>                            
                        </xsl:otherwise>
                    </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test=".//dcadesc:subject [contains(text(),'Senior')]">
                            <marc:datafield tag="590" ind1="" ind2="">
                                <marc:subfield code="a">Tufts Senior Honors thesis.</marc:subfield>
                            </marc:datafield></xsl:when>
                    </xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test=".//dcadesc:subject [contains(text(),'Senior honors thesis.')]">
                            <xsl:for-each select=".//dcadesc:subject[position()>2]">
                        ...
                        <xsl:otherwise>
                            <xsl:for-each select=".//dcadesc:subject[position()>1]">
                                <marc:datafield tag="650" ind1="" ind2="0">
                                    <marc:subfield code="a">
                                        <xsl:value-of select="normalize-space(replace(.,'--','&lt;/marc:subfield&gt;&lt;marc:subfield code=&quot;x&quot;&gt;'))"/>
                                    </marc:subfield>
